...
const MyDateRangeLocal = ({
  ...
  const computedMaxDate = maxDate || today
        ...
        <div className="flex w-[328px] flex-col">
                    ...
                    <div className="flex items-center gap-2">
                      <MyTextField
                        ...
                        endAdornment={
                          isInvalidStartDate && (
                            <AlertTriangle
                              className="size-5 text-error/700"
                              stroke={'currentColor'}
                            />
                          )
                        }
          ...
          <footer className="flex items-center gap-3 border-t border-gray-light/200 p-4">
            <button
              onClick={close}
              type="button"
              className="shadow-shadows/shadow-xs flex flex-1 items-center justify-center gap-x-1 rounded-md border border-gray-light/300 px-[14px] py-2.5 text-center"
            >
...
export default MyDateRangeLocal
