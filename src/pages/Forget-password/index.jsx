...
import { Ingenico } from '@interstellar-component'
...
function ForgetPassword() {
  ...
  return (
    <main className="container flex">
      {/* LEFT */}
      <div className="min-h-screen w-full bg-gray-light/100 px-8 pt-12 max-sm:hidden md:w-[440px]">
        {/* logo */}
        ...
        <div className="md:gap-x-10">
          ...
          <div className="flex flex-col gap-4 md:flex-row">
            ...
            <div className="max-sm:hidden">
              <p
                className={`text-sm-${
                  currentStep.step_1 ? 'bold' : 'regular'
                } text-gray-light/700`}
              >
                Your details
              </p>
          ...
          <div className="flex flex-col gap-4 md:flex-row">
            ...
            <div className="max-sm:hidden">
              <p
                className={`text-sm-${
                  currentStep.step_2 ? 'bold' : 'regular'
                } text-gray-light/700`}
              >
                Check your email
              </p>
          ...
          <div className="flex flex-col gap-4 md:flex-row">
            ...
            <div className="max-sm:hidden">
              <p
                className={`text-sm-${
                  currentStep.step_3 ? 'bold' : 'regular'
                } text-gray-light/700`}
              >
                Set new password
              </p>
          ...
          <div className="flex gap-4">
            ...
            <div className="max-sm:hidden">
              <p
                className={`text-sm-${
                  currentStep.step_4 ? 'bold' : 'regular'
                } text-gray-light/700`}
              >
                Password reset
              </p>
