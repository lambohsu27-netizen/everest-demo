...
export default function AwaitingAdminApprovalSlider({ data }) {
    ...
    <div className="flex h-screen w-[420px] flex-col bg-white shadow-xl">
      ...
      <header className="relative flex items-start gap-x-4 px-6 py-6 border-b border-gray-100 pb-4">
        ...
        <div className="flex flex-1 flex-col gap-2">
          ...
          <div className="w-max">
            <MySLAStatusChip status="Awaiting Admin Approval" />
          </div>
        </div>
      </header>
                ...
                <div className="flex items-center justify-between p-4">
                  ...
                  <div className="flex items-center gap-3 text-right">
                    ...
                    <div className="flex flex-col text-right">
                      <span className="text-sm font-semibold text-gray-900">{displayData.name}</span>
                      <span className="text-sm font-medium text-gray-900">{displayData.employeeId}</span>
