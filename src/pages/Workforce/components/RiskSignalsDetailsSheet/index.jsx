        ...
        <div className="grid lg:grid-cols-12 gap-8 pt-4">
            ...
            <div className="flex flex-col gap-5">
              <MyDoubleCard heading="Key takeaway">
                <p className="text-sm-regular text-gray-600 leading-relaxed">
                  Contact intelligence identified 8 phone numbers linked to the individual, with
                  most labels matching the individual’s name or professional identity, indicating
                  consistent recognition by others.
                </p>
              </MyDoubleCard>

              <RiskAssessmentTable data={riskIndicators} />
            </div>
          </div>
          ...
          <div className="lg:col-span-8 flex flex-col gap-6">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm-regular text-gray-600">
                List of phone numbers linked to the individual across credit bureau records and
            ...
            <div className="flex flex-col gap-0 border border-gray-200 rounded-xl bg-white shadow-sm overflow-hidden">
              ...
              <MyDataTable values={{ data: phoneData }} className="border-none shadow-none">
                ...
                <MyColumn
                  header="Aging"
                  field="aging"
                  body={(row) => <span className="text-sm-regular text-gray-600">{row.aging}</span>}
                />
                <MyColumn
                  header="Last Update Date"
                  field="lastUpdate"
                  body={(row) => (
                    <span className="text-sm-regular text-gray-600">{row.lastUpdate}</span>
                  )}
                />
              </MyDataTable>
